...
public class GuestAllNewsAdapter extends BaseAdapter {
    ProgressDialog progressDialog;
    List<GetAllNewsPojo> getAllNewsPojos;
    Context cnt;
    public GuestAllNewsAdapter(List<GetAllNewsPojo> ar, Context cnt)
    {
    ...
    public View getView(final int pos, View view, ViewGroup viewGroup)
    {
        ...
        View obj2=obj1.inflate(R.layout.list_guest_all_news,null);
