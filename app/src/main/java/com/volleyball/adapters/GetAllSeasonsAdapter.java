...
public class GetAllSeasonsAdapter extends BaseAdapter {
    List<GetAllSeasonsPojo> getAllSeasonsPojo;
    Context cnt;
    public GetAllSeasonsAdapter(List<GetAllSeasonsPojo> ar, Context cnt)
    {
...
//                Intent intent=new Intent(cnt, GetAllTeamsActivity.class);
