...
public class AllPlayersAdapter extends BaseAdapter {
    ...
    Context cnt;
    public AllPlayersAdapter(List<PlayerPojo> ar, Context cnt)
    {
        this.playerPojo=ar;
        this.cnt=cnt;
    }
    ...
    public View getView(final int pos, View view, ViewGroup viewGroup)
    {
        ...
        View obj2=obj1.inflate(R.layout.list_all_players,null);
        ...
        im_edit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //intent.putExtra("id",playerPojo.get(pos).getTeam_id());
