...
public class TeamTwoScoreFragment extends Fragment {
    View view;
    Button firstButton;
    ListView list_view;
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_team_two_score, container, false);

        list_view=(ListView)view.findViewById(R.id.list_view);

        String team=((TeamScoreDetailsActivity) getActivity()).t2;
